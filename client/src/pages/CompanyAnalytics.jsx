    ...
    <div className="flex bg-bg min-h-screen">
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          ...
          <p className="text-muted text-sm mb-6">Hiring trends and application insights.</p>
          <div className="card">
            {/* TODO: charts - applications over time, top skills, conversion funnel */}
            <p className="text-sm text-muted">Charts go here.</p>
          </div>
        </div>
      </div>
    </div>
