    ...
    <div className="flex bg-bg min-h-screen">
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          ...
          <p className="text-muted text-sm mb-6">Manage the courses you teach.</p>
          <div className="card">
            {/* TODO: list of courses with student count, add/edit */}
            <p className="text-sm text-muted">Courses list goes here.</p>
          </div>
        </div>
      </div>
    </div>
