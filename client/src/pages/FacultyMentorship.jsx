    ...
    <div className="flex bg-bg min-h-screen">
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          ...
          <p className="text-muted text-sm mb-6">Schedule and track mentorship sessions.</p>
          <div className="card">
            {/* TODO: upcoming/past sessions, schedule new session form */}
            <p className="text-sm text-muted">Mentorship sessions go here.</p>
          </div>
        </div>
      </div>
    </div>
