    ...
    <div className="flex bg-bg min-h-screen">
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          ...
          <p className="text-muted text-sm mb-6">Manage programs offered to students.</p>
          <div className="card">
            {/* TODO: programs list, add/edit */}
            <p className="text-sm text-muted">Learning programs go here.</p>
          </div>
        </div>
      </div>
    </div>
