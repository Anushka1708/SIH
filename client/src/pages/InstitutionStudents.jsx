    ...
    <div className="flex bg-bg min-h-screen">
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          ...
          <p className="text-muted text-sm mb-6">Manage enrolled students.</p>
          <div className="card">
            {/* TODO: student directory, search/filter */}
            <p className="text-sm text-muted">Students list goes here.</p>
          </div>
        </div>
      </div>
    </div>
