...
export async function seedDemoData() {
  ...
  const studentProfile = await StudentProfile.create({
    ...
    roadmap: [
      {
        title: "Containerization & Kubernetes Basics",
        description: "Build robust Docker container pipelines and master Kubernetes orchestration fundamentals.",
        relatedSkill: skillMap["Cloud DevOps"]?._id,
        done: true,
      },
      {
        title: "Microservices CI/CD with GitHub Actions",
        description: "Automate build verification, unit test suites, and container registry publishing.",
        relatedSkill: skillMap["Cloud DevOps"]?._id,
        done: false,
      },
      {
        title: "Production Observability with Prometheus & Grafana",
        description: "Instrument microservice latency metrics and configure automated alert triggers.",
        relatedSkill: skillMap["Cloud DevOps"]?._id,
        done: false,
      },
    ],
